...
There are many conventions for naming your variables, but the most important one is using a name that means something in your code. For example, if you are counting button presses then the following might be appropriate.
